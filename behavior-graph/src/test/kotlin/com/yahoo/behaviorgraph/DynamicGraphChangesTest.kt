...
class DynamicGraphChangesTest : AbstractBehaviorGraphTest() {
    ...
    @Test
    fun `can add and update in the same event`() {
    ...
    @Test
    fun `changing to a demand a resource that has already been updated this event will activate behavior`() {
    ...
    @Test
    fun `setDynamic can include undefined`() {
    ...
    @Test
    fun `can relink dynamicSupplies after a behavior runs`() {
